  ...
  static class Solution3 {
    public double findMedianSortedArrays(List<Integer> nums1, List<Integer> nums2) {
      ...
      while (left <= right) {
        ...
        int nums_im1 = (i == 0 ? Integer.MIN_VALUE : nums1.get(i - 1));
        int nums_i = (i == m ? Integer.MAX_VALUE : nums1.get(i));
        int nums_jm1 = (j == 0 ? Integer.MIN_VALUE : nums2.get(j - 1));
        int nums_j = (j == n ? Integer.MAX_VALUE : nums2.get(j));
